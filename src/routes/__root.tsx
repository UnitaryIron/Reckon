...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Reckon" },
      { name: "description", content: "Snap a selfie, answer 4 fun questions, get a personalized skincare shortlist. No guessing." },
      { property: "og:title", content: "Reckon" },
      { property: "og:description", content: "Snap a selfie, answer 4 fun questions, get a personalized skincare shortlist. No guessing." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Reckon" },
      { name: "twitter:description", content: "Snap a selfie, answer 4 fun questions, get a personalized skincare shortlist. No guessing." },
